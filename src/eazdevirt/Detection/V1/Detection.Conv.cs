...
namespace eazdevirt.Detection.V1.Ext
{
	public static partial class Extensions
	{
		...
		private static Boolean _Is_Conv_I(EazVirtualInstruction ins, Boolean ovf, IList<Code> helperPattern)
		{
		...
		[Detect(Code.Conv_I)]
		public static Boolean Is_Conv_I(this EazVirtualInstruction ins)
		{
			return _Is_Conv_I(ins, false, Pattern_Conv_I);
		}

		[Detect(Code.Conv_Ovf_I)]
		public static Boolean Is_Conv_Ovf_I(this EazVirtualInstruction ins)
		{
		...
		[Detect(Code.Conv_I1)]
		public static Boolean Is_Conv_I1(this EazVirtualInstruction ins)
		{
			return _Is_Conv_I(ins, false, Pattern_Conv_I1);
		}

		[Detect(Code.Conv_Ovf_I1)]
		public static Boolean Is_Conv_Ovf_I1(this EazVirtualInstruction ins)
		{
		...
		[Detect(Code.Conv_I2)]
		public static Boolean Is_Conv_I2(this EazVirtualInstruction ins)
		{
			return _Is_Conv_I(ins, false, Pattern_Conv_I2);
		}

		[Detect(Code.Conv_Ovf_I2)]
		public static Boolean Is_Conv_Ovf_I2(this EazVirtualInstruction ins)
		{
		...
		[Detect(Code.Conv_I8)]
		public static Boolean Is_Conv_I8(this EazVirtualInstruction ins)
		{
			return _Is_Conv_I(ins, false, Pattern_Conv_I8);
		}

		[Detect(Code.Conv_Ovf_I8)]
		public static Boolean Is_Conv_Ovf_I8(this EazVirtualInstruction ins)
		{
			return _Is_Conv_I(ins, true, Pattern_Conv_I8);
		}

		[Detect(Code.Conv_Ovf_I_Un)]
		public static Boolean Is_Conv_Ovf_I_Un(this EazVirtualInstruction ins)
		{
		...
		[Detect(Code.Conv_R4)]
		public static Boolean Is_Conv_R4(this EazVirtualInstruction ins)
		{
